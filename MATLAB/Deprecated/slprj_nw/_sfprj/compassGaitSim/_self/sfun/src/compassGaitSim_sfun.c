  ...
  unsigned int chartFileNumber, const char* specsCksum, int_T method, void *data)
{
  ...
  if (chartFileNumber==3) {
    c3_compassGaitSim_method_dispatcher(simstructPtr, method, data);
    return 1;
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
  ...
  if (nrhs>1 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"machine")) {
      ...
      ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2786494152U);
      ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2747111916U);
      ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3052443331U);
      ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3434851677U);
      ...
      switch (chartFileNumber) {
       ...
       case 3:
        {
          extern void sf_c3_compassGaitSim_get_check_sum(mxArray *plhs[]);
          sf_c3_compassGaitSim_get_check_sum(plhs);
          break;
        }
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(797522598U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(883597202U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(623685687U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(492093077U);
  }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(aiChksum, "3FPXQpO48UsvlGAiKOhGrG") == 0) {
     ...
     case 3:
      {
        if (strcmp(aiChksum, "i97ULWosFKoJMk0NQRscGH") == 0) {
          extern mxArray *sf_c3_compassGaitSim_get_autoinheritance_info(void);
          plhs[0] = sf_c3_compassGaitSim_get_autoinheritance_info();
          break;
        }
     ...
     case 4:
      {
        if (strcmp(aiChksum, "U6uNMAaqo2XcWJpKROEKPF") == 0) {
...

  {
    ...
    switch (chartFileNumber) {
     ...
     case 3:
      {
        extern const mxArray
          *sf_c3_compassGaitSim_get_eml_resolved_functions_info(void);
        mxArray *persistentMxArray = (mxArray *)
          sf_c3_compassGaitSim_get_eml_resolved_functions_info();
        plhs[0] = mxDuplicateArray(persistentMxArray);
        mxDestroyArray(persistentMxArray);
        break;
      }
  ...
  int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 1:
      {
        if (strcmp(tpChksum, "nUxrGoYQjQXxJjecq3upWF") == 0) {
     ...
     case 3:
      {
        if (strcmp(tpChksum, "3oLs4EcRG4TSjdagR3hNXB") == 0) {
          extern mxArray *sf_c3_compassGaitSim_third_party_uses_info(void);
          plhs[0] = sf_c3_compassGaitSim_third_party_uses_info();
          break;
        }
      }
     ...
     case 4:
      {
        if (strcmp(tpChksum, "8G6S05MPcFcLL3rftLtF6B") == 0) {
