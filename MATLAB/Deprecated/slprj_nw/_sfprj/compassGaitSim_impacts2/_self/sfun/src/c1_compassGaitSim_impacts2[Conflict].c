...
static void initSimStructsc1_compassGaitSim_impacts2
  (SFc1_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void registerMessagesc1_compassGaitSim_impacts2
  (SFc1_compassGaitSim_impacts2InstanceStruct *chartInstance);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2476885150U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(489013904U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3950186491U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2412386207U);
}
...
mxArray *sf_c1_compassGaitSim_impacts2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("8QH3W4DHQ8NZMHtQfaKTfC");
...
mxArray *sf_c1_compassGaitSim_impacts2_third_party_uses_info(void)
{
...
static void mdlSetWorkWidths_c1_compassGaitSim_impacts2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3554308976U));
  ssSetChecksum1(S,(3354888240U));
  ssSetChecksum2(S,(2450266346U));
  ssSetChecksum3(S,(4030260717U));
...
{
  SFc1_compassGaitSim_impacts2InstanceStruct *chartInstance;
  chartInstance = (SFc1_compassGaitSim_impacts2InstanceStruct *)utMalloc(sizeof
