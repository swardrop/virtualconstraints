  ...
  (SFc1_compassGaitSimInstanceStruct *chartInstance)
{
  ...
  c1_b_hoistedGlobal = chartInstance->c1_is_active_c1_compassGaitSim;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(856191964U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3588956881U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(723848357U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1152764815U);
}
...
mxArray *sf_c1_compassGaitSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("3FPXQpO48UsvlGAiKOhGrG");
...
static const mxArray *sf_get_sim_state_info_c1_compassGaitSim(void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"T2\",},{M[8],M[0],T\"is_active_c1_compassGaitSim\",}}"
  };
...
static void mdlSetWorkWidths_c1_compassGaitSim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2226625085U));
  ssSetChecksum1(S,(781837408U));
  ssSetChecksum2(S,(2410075003U));
  ssSetChecksum3(S,(3952073620U));
