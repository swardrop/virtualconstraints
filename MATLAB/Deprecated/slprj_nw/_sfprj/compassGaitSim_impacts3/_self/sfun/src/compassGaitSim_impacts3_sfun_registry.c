...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_compassGaitSim_impacts3_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_compassGaitSim_impacts3_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_compassGaitSim_impacts3_autoinheritance_info( int nlhs,
  ...
  if (strcmp(machineName, "compassGaitSim_impacts3") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_compassGaitSim_impacts3_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_compassGaitSim_impacts3_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "compassGaitSim_impacts3") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_compassGaitSim_impacts3_get_eml_resolved_functions_info(nlhs,plhs,
      2,newRhs);
  }
...
extern unsigned int sf_compassGaitSim_impacts3_method_dispatcher(SimStruct *S,
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"compassGaitSim_impacts3")) {
    return(sf_compassGaitSim_impacts3_method_dispatcher(simstructPtr,
...
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    compassGaitSim_impacts3_terminator();
    sf_debug_terminate();
  }
...
extern void compassGaitSim_impacts3_register_exported_symbols(SimStruct* S);
extern void compassGaitSim_impacts3_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  compassGaitSim_impacts3_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      compassGaitSim_impacts3_debug_initialize();
    }

    compassGaitSim_impacts3_initializer();
  }
