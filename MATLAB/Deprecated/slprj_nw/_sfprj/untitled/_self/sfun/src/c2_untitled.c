...
static const char * c2_debug_family_names[5] = { "nargin", "nargout", "x", "v",
  "a" };
...
const mxArray *sf_c2_untitled_get_eml_resolved_functions_info(void)
{
  ...
  (*c2_b_info)[1].fileTimeLo = 1357915548U;
  ...
  (*c2_b_info)[2].fileTimeLo = 1346481588U;
  ...
  (*c2_b_info)[3].fileTimeLo = 1286786396U;
  ...
  (*c2_b_info)[4].fileTimeLo = 1313319010U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3372261592U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3561224794U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2354442892U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(454312742U);
}
...
mxArray *sf_c2_untitled_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("970synk6VyXXX1Aoyt101");
...
static void mdlSetWorkWidths_c2_untitled(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(3679323341U));
  ssSetChecksum1(S,(4211710576U));
  ssSetChecksum2(S,(1156072270U));
  ssSetChecksum3(S,(1215055984U));
