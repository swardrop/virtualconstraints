...
static void initialize_c2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
static void initialize_params_c2_compassGaitSim
  (SFc2_compassGaitSimInstanceStruct *chartInstance);
static void enable_c2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
static void disable_c2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_compassGaitSim
  (SFc2_compassGaitSimInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_compassGaitSim
  (SFc2_compassGaitSimInstanceStruct *chartInstance);
static void set_sim_state_c2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
static void sf_c2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
static void initSimStructsc2_compassGaitSim(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
static void registerMessagesc2_compassGaitSim(SFc2_compassGaitSimInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_compassGaitSimInstanceStruct
  *chartInstance, const mxArray *c2_t2dd, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_compassGaitSimInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[17]);
static real_T c2_mpower(SFc2_compassGaitSimInstanceStruct *chartInstance, real_T
  c2_a);
static void c2_eml_scalar_eg(SFc2_compassGaitSimInstanceStruct *chartInstance);
static real_T c2_b_mpower(SFc2_compassGaitSimInstanceStruct *chartInstance,
  real_T c2_a);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_compassGaitSimInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_compassGaitSimInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_compassGaitSim, const char_T *
  c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_compassGaitSimInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_compassGaitSimInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_compassGaitSim = 0U;
}
  ...
  (SFc2_compassGaitSimInstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_compassGaitSim;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_t2dd = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "t2dd");
  chartInstance->c2_is_active_c2_compassGaitSim = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_compassGaitSim");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_compassGaitSim(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_compassGaitSim(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_compassGaitSimInstanceStruct *chartInstance;
  chartInstance = (SFc2_compassGaitSimInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_compassGaitSim_get_eml_resolved_functions_info(void)
{
  ...
  c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_compassGaitSim), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_compassGaitSim);
  return c2_y;
}
...
void sf_c2_compassGaitSim_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_compassGaitSim_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_compassGaitSim_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_compassGaitSim(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"t1dd\",},{M[1],M[11],T\"t2dd\",},{M[8],M[0],T\"is_active_c2_compassGaitSim\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_compassGaitSim_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_compassGaitSimInstanceStruct *chartInstance;
    chartInstance = (SFc2_compassGaitSimInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_compassGaitSim(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_compassGaitSimInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*)
    chartInstanceVar);
  initialize_c2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_compassGaitSim(void *chartInstanceVar)
{
  enable_c2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_compassGaitSim(void *chartInstanceVar)
{
  disable_c2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_compassGaitSim(void *chartInstanceVar)
{
  sf_c2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_compassGaitSim(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_compassGaitSim
    ((SFc2_compassGaitSimInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_compassGaitSim();/* state var info */
...
extern void sf_internal_set_sim_state_c2_compassGaitSim(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_compassGaitSim(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_compassGaitSim(S);
}

static void sf_opaque_set_sim_state_c2_compassGaitSim(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_compassGaitSim(S, st);
}

static void sf_opaque_terminate_c2_compassGaitSim(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_compassGaitSimInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_compassGaitSim_optimization_info();
    }

    finalize_c2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_compassGaitSim((SFc2_compassGaitSimInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_compassGaitSim(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_compassGaitSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_compassGaitSim(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_compassGaitSim(SimStruct *S)
{
  SFc2_compassGaitSimInstanceStruct *chartInstance;
  chartInstance = (SFc2_compassGaitSimInstanceStruct *)utMalloc(sizeof
    (SFc2_compassGaitSimInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_compassGaitSimInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_compassGaitSim;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_compassGaitSim;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_compassGaitSim;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_compassGaitSim;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_compassGaitSim;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_compassGaitSim;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_compassGaitSim;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_compassGaitSim;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_compassGaitSim;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_compassGaitSim;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_compassGaitSim;
...
void c2_compassGaitSim_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_compassGaitSim(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_compassGaitSim(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_compassGaitSim(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_compassGaitSim_method_dispatcher.\n"
