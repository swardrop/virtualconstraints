...
static void initialize_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void initialize_params_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void enable_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void disable_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void set_sim_state_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void sf_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void c2_chartstep_c2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void initSimStructsc2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void registerMessagesc2_compassGaitSim_impacts2
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_compassGaitSim_impacts2InstanceStruct
  *chartInstance, const mxArray *c2_t2dd, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_compassGaitSim_impacts2InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[17]);
static real_T c2_mpower(SFc2_compassGaitSim_impacts2InstanceStruct
  *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_compassGaitSim_impacts2InstanceStruct
  *chartInstance);
static real_T c2_b_mpower(SFc2_compassGaitSim_impacts2InstanceStruct
  *chartInstance, real_T c2_a);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_compassGaitSim_impacts2InstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_compassGaitSim_impacts2InstanceStruct *
  chartInstance, const mxArray *c2_b_is_active_c2_compassGaitSim_impacts2, const
  char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_compassGaitSim_impacts2InstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_compassGaitSim_impacts2InstanceStruct
  *chartInstance);
  ...
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_compassGaitSim_impacts2 = 0U;
}
  ...
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_compassGaitSim_impacts2;
   ...
   *c2_st)
{
  ...
  *c2_t2dd = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "t2dd");
  chartInstance->c2_is_active_c2_compassGaitSim_impacts2 = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_compassGaitSim_impacts2");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_compassGaitSim_impacts2(chartInstance);
  ...
  (SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_compassGaitSim_impacts2(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance;
  chartInstance = (SFc2_compassGaitSim_impacts2InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_compassGaitSim_impacts2_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_compassGaitSim_impacts2), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_compassGaitSim_impacts2);
  return c2_y;
}
...
void sf_c2_compassGaitSim_impacts2_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_compassGaitSim_impacts2_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_compassGaitSim_impacts2_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

static const mxArray *sf_get_sim_state_info_c2_compassGaitSim_impacts2(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"t1dd\",},{M[1],M[11],T\"t2dd\",},{M[8],M[0],T\"is_active_c2_compassGaitSim_impacts2\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_compassGaitSim_impacts2_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_compassGaitSim_impacts2(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_compassGaitSim_impacts2InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_compassGaitSim_impacts2
    ((SFc2_compassGaitSim_impacts2InstanceStruct*) chartInstanceVar);
  initialize_c2_compassGaitSim_impacts2
    ((SFc2_compassGaitSim_impacts2InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_compassGaitSim_impacts2(void *chartInstanceVar)
{
  enable_c2_compassGaitSim_impacts2((SFc2_compassGaitSim_impacts2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_compassGaitSim_impacts2(void *chartInstanceVar)
{
  disable_c2_compassGaitSim_impacts2((SFc2_compassGaitSim_impacts2InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_compassGaitSim_impacts2(void *chartInstanceVar)
{
  sf_c2_compassGaitSim_impacts2((SFc2_compassGaitSim_impacts2InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_compassGaitSim_impacts2
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_compassGaitSim_impacts2
    ((SFc2_compassGaitSim_impacts2InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_compassGaitSim_impacts2();/* state var info */
...
extern void sf_internal_set_sim_state_c2_compassGaitSim_impacts2(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_compassGaitSim_impacts2
    ((SFc2_compassGaitSim_impacts2InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_compassGaitSim_impacts2
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_compassGaitSim_impacts2(S);
}

static void sf_opaque_set_sim_state_c2_compassGaitSim_impacts2(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_compassGaitSim_impacts2(S, st);
}

static void sf_opaque_terminate_c2_compassGaitSim_impacts2(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_compassGaitSim_impacts2InstanceStruct*)
                    chartInstanceVar)->S;
    ...
    finalize_c2_compassGaitSim_impacts2
      ((SFc2_compassGaitSim_impacts2InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_compassGaitSim_impacts2
    ((SFc2_compassGaitSim_impacts2InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_compassGaitSim_impacts2(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_compassGaitSim_impacts2
      ((SFc2_compassGaitSim_impacts2InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_compassGaitSim_impacts2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_compassGaitSim_impacts2(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_compassGaitSim_impacts2(SimStruct *S)
{
  SFc2_compassGaitSim_impacts2InstanceStruct *chartInstance;
  chartInstance = (SFc2_compassGaitSim_impacts2InstanceStruct *)utMalloc(sizeof
    (SFc2_compassGaitSim_impacts2InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_compassGaitSim_impacts2InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_compassGaitSim_impacts2;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_compassGaitSim_impacts2;
...
void c2_compassGaitSim_impacts2_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_compassGaitSim_impacts2(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_compassGaitSim_impacts2(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_compassGaitSim_impacts2(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_compassGaitSim_impacts2_method_dispatcher.\n"
