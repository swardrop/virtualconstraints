...
static const char * c4_debug_family_names[14] = { "height", "x", "ind", "nargin",
  "nargout", "t1", "ground_x", "ground_y", "t2", "l1", "l2", "y_prev", "impact",
  "y" };
  ...
  *chartInstance)
{
  ...
  real_T *c4_y_prev;
  real_T *c4_y;
  real_T (*c4_ground_y)[2];
  real_T (*c4_ground_x)[2];
  c4_y = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  ...
  c4_impact = (boolean_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c4_ground_y = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 2);
  c4_ground_x = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
  c4_t1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 3U, chartInstance->c4_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c4_t1, 0U);
  for (c4_i0 = 0; c4_i0 < 2; c4_i0++) {
    _SFD_DATA_RANGE_CHECK((*c4_ground_x)[c4_i0], 1U);
  }

  for (c4_i1 = 0; c4_i1 < 2; c4_i1++) {
    _SFD_DATA_RANGE_CHECK((*c4_ground_y)[c4_i1], 2U);
  }
  ...
  *chartInstance)
{
  ...
  real_T *c4_f_y;
  real_T (*c4_b_ground_y)[2];
  real_T (*c4_b_ground_x)[2];
  ...
  c4_b_ground_y = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 2);
  c4_b_ground_x = (real_T (*)[2])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  for (c4_i2 = 0; c4_i2 < 2; c4_i2++) {
    c4_ground_x[c4_i2] = (*c4_b_ground_x)[c4_i2];
  }

  for (c4_i3 = 0; c4_i3 < 2; c4_i3++) {
    c4_ground_y[c4_i3] = (*c4_b_ground_y)[c4_i3];
  }
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_DYN_IMPORTABLE(c4_ind_data, (const int32_T *)
    &c4_ind_sizes, NULL, 0, 2, (void *)c4_d_sf_marshallOut, (void *)
    c4_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_DYN_IMPORTABLE(c4_height_data, (const int32_T *)
    &c4_height_sizes, NULL, 0, -1, (void *)c4_d_sf_marshallOut, (void *)
    c4_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c4_nargout, 4U, c4_sf_marshallOut,
    c4_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c4_t1, 5U, c4_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_ground_x, 6U, c4_c_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(c4_ground_y, 7U, c4_c_sf_marshallOut);
  ...
  for (c4_i4 = 0; c4_i4 < 2; c4_i4++) {
    c4_j_x[c4_i4] = (c4_x > c4_ground_x[c4_i4]);
  }
  ...
  for (c4_i6 = 0; c4_i6 <= c4_b_loop_ub; c4_i6++) {
    c4_height_data[c4_i6] = c4_ground_y[(int32_T)c4_ind_data[c4_i6] - 1];
  }
  ...
  if (CV_EML_COND(0, 1, 0, c4_y <= c4_height)) {
    if (CV_EML_COND(0, 1, 1, c4_y_prev > 0.0)) {
  ...
  *c4_inData)
{
  ...
  for (c4_i7 = 0; c4_i7 < 2; c4_i7++) {
    c4_b_inData[c4_i7] = (*(real_T (*)[2])c4_inData)[c4_i7];
  }
  ...
  real_T c4_y_data[1], int32_T c4_y_sizes[1])
{
  ...
  for (c4_i11 = 0; c4_i11 <= c4_loop_ub; c4_i11++) {
    c4_y_data[c4_i11] = c4_tmp_data[c4_i11];
  }
  ...
  int32_T c4_outData_sizes[1])
{
  ...
  for (c4_i12 = 0; c4_i12 <= c4_loop_ub; c4_i12++) {
    c4_outData_data[c4_i12] = c4_y_data[c4_i12];
  }
...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[20])
{
  ...
  c4_info[17].name = "intmax";
  c4_info[17].dominantType = "char";
  c4_info[17].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m";
  c4_info[17].fileTimeLo = 1311226516U;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(401633854U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(923867583U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3660380678U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(749589595U);
}
...
mxArray *sf_c4_compassGaitSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("U6uNMAaqo2XcWJpKROEKPF");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"ground_x");
          _SFD_SET_DATA_PROPS(2,1,1,0,"ground_y");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,438,478,-1,501);

        {
          static int condStart[] = { 441, 456, 470 };

          static int condEnd[] = { 452, 466, 478 };

          static int pfixExpr[] = { 0, 1, -3, 2, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,441,478,3,0,&(condStart[0]),&(condEnd[0]),
                                5,&(pfixExpr[0]));
        }
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(1U, *c4_ground_x);
          _SFD_SET_DATA_VALUE_PTR(2U, *c4_ground_y);
...
static void mdlSetWorkWidths_c4_compassGaitSim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(850482587U));
  ssSetChecksum1(S,(2252762558U));
  ssSetChecksum2(S,(565750840U));
  ssSetChecksum3(S,(2870753913U));
