...
#include "c2_compassGaitSim_impacts3.h"
...
static void initialize_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void initialize_params_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void enable_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void disable_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void set_sim_state_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void sf_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void c2_chartstep_c2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void initSimStructsc2_compassGaitSim_impacts3
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static real_T c2_emlrt_marshallIn(SFc2_compassGaitSim_impacts3InstanceStruct
  *chartInstance, const mxArray *c2_t2dd, const char_T *c2_identifier);
static real_T c2_b_emlrt_marshallIn(SFc2_compassGaitSim_impacts3InstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[13]);
static real_T c2_mpower(SFc2_compassGaitSim_impacts3InstanceStruct
  *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_compassGaitSim_impacts3InstanceStruct
  *chartInstance);
static real_T c2_b_mpower(SFc2_compassGaitSim_impacts3InstanceStruct
  *chartInstance, real_T c2_a);
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_c_emlrt_marshallIn(SFc2_compassGaitSim_impacts3InstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_d_emlrt_marshallIn(SFc2_compassGaitSim_impacts3InstanceStruct *
  chartInstance, const mxArray *c2_b_is_active_c2_compassGaitSim_impacts3, const
  char_T *c2_identifier);
static uint8_T c2_e_emlrt_marshallIn(SFc2_compassGaitSim_impacts3InstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_compassGaitSim_impacts3InstanceStruct
  *chartInstance);
  ...
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_compassGaitSim_impacts3 = 0U;
}
  ...
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance)
{
  ...
  c2_c_hoistedGlobal = chartInstance->c2_is_active_c2_compassGaitSim_impacts3;
   ...
   *c2_st)
{
  ...
  *c2_t2dd = c2_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c2_u,
    1)), "t2dd");
  chartInstance->c2_is_active_c2_compassGaitSim_impacts3 = c2_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 2)),
     "is_active_c2_compassGaitSim_impacts3");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_compassGaitSim_impacts3(chartInstance);
  ...
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_compassGaitSim_impacts3(chartInstance);
  ...
  (SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance)
{
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_c1, 0U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_c2, 1U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_s2, 2U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_c12, 3U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargin, 4U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 5U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_T1, 6U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_T2, 7U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_t1d, 8U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_t2d, 9U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_t1, 10U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_t2, 11U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_I1, 12U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_l1, 13U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_m1, 14U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_I2, 15U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_l2, 16U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_m2, 17U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_g, 18U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_t1dd, 19U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_t2dd, 20U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance;
  chartInstance = (SFc2_compassGaitSim_impacts3InstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_compassGaitSim_impacts3_get_eml_resolved_functions_info
  (void)
{
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[13])
{
  ...
  c2_info[0].resolved =
    "[ILXE]C:/Program Files (x86)/MATLAB/R2012a Student/toolbox/eml/lib/matlab/elfun/cos.m";
  c2_info[0].fileTimeLo = 1286786306U;
  ...
  c2_info[1].resolved =
    "[ILXE]C:/Program Files (x86)/MATLAB/R2012a Student/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m";
  ...
  c2_info[2].resolved =
    "[ILXE]C:/Program Files (x86)/MATLAB/R2012a Student/toolbox/eml/lib/matlab/elfun/sin.m";
  c2_info[2].fileTimeLo = 1286786350U;
  ...
  c2_info[3].resolved =
    "[ILXE]C:/Program Files (x86)/MATLAB/R2012a Student/toolbox/eml/lib/matlab/elfun/eml_scalar_sin.m";
  ...
  c2_info[6].fileTimeLo = 1307622440U;
  ...
  c2_info[10].fileTimeLo = 1325088138U;
  c2_info[10].fileTimeHi = 0U;
  c2_info[10].mFileTimeLo = 1319697566U;
  ...
  c2_info[11].fileTimeLo = 1286786444U;
  ...
  c2_info[12].fileTimeLo = 1313319010U;
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_compassGaitSim_impacts3), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_compassGaitSim_impacts3);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_compassGaitSim_impacts3_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4201981817U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3818196428U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1453096417U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3042286063U);
}

mxArray *sf_c2_compassGaitSim_impacts3_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("RGCFwXTHi5fR1ROZu4RdcB");
...
static const mxArray *sf_get_sim_state_info_c2_compassGaitSim_impacts3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"t1dd\",},{M[1],M[11],T\"t2dd\",},{M[8],M[0],T\"is_active_c2_compassGaitSim_impacts3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_compassGaitSim_impacts3_get_check_sum(&mxChecksum);
...
{
  return "s9c1uS9I2v98RD9bmstZFB";
}

static void sf_opaque_initialize_c2_compassGaitSim_impacts3(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_compassGaitSim_impacts3InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_compassGaitSim_impacts3
    ((SFc2_compassGaitSim_impacts3InstanceStruct*) chartInstanceVar);
  initialize_c2_compassGaitSim_impacts3
    ((SFc2_compassGaitSim_impacts3InstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_compassGaitSim_impacts3(void *chartInstanceVar)
{
  enable_c2_compassGaitSim_impacts3((SFc2_compassGaitSim_impacts3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_compassGaitSim_impacts3(void *chartInstanceVar)
{
  disable_c2_compassGaitSim_impacts3((SFc2_compassGaitSim_impacts3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_compassGaitSim_impacts3(void *chartInstanceVar)
{
  sf_c2_compassGaitSim_impacts3((SFc2_compassGaitSim_impacts3InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_compassGaitSim_impacts3
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_compassGaitSim_impacts3
    ((SFc2_compassGaitSim_impacts3InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_compassGaitSim_impacts3();/* state var info */
...
extern void sf_internal_set_sim_state_c2_compassGaitSim_impacts3(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_compassGaitSim_impacts3
    ((SFc2_compassGaitSim_impacts3InstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_compassGaitSim_impacts3
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_compassGaitSim_impacts3(S);
}

static void sf_opaque_set_sim_state_c2_compassGaitSim_impacts3(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_compassGaitSim_impacts3(S, st);
}

static void sf_opaque_terminate_c2_compassGaitSim_impacts3(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_compassGaitSim_impacts3InstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_compassGaitSim_impacts3
      ((SFc2_compassGaitSim_impacts3InstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_compassGaitSim_impacts3
    ((SFc2_compassGaitSim_impacts3InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_compassGaitSim_impacts3(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_compassGaitSim_impacts3
      ((SFc2_compassGaitSim_impacts3InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c2_compassGaitSim_impacts3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2155351124U));
  ssSetChecksum1(S,(4230182723U));
  ssSetChecksum2(S,(2973575181U));
  ssSetChecksum3(S,(3387453942U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_compassGaitSim_impacts3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_compassGaitSim_impacts3(SimStruct *S)
{
  SFc2_compassGaitSim_impacts3InstanceStruct *chartInstance;
  chartInstance = (SFc2_compassGaitSim_impacts3InstanceStruct *)malloc(sizeof
    (SFc2_compassGaitSim_impacts3InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_compassGaitSim_impacts3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_compassGaitSim_impacts3;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_compassGaitSim_impacts3;
...
void c2_compassGaitSim_impacts3_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_compassGaitSim_impacts3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_compassGaitSim_impacts3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_compassGaitSim_impacts3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_compassGaitSim_impacts3_method_dispatcher.\n"
