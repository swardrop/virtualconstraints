...
static void c6_bezConstraint(SFc6_RobotSimInstanceStruct *chartInstance, real_T
  c6_theta_p[16], real_T c6_alpha_p[16], real_T c6_theta, real_T c6_q[2]);
...
static void sf_c6_RobotSim(SFc6_RobotSimInstanceStruct *chartInstance)
{
  ...
  real_T c6_hoistedGlobal;
  int32_T c6_i3;
  real_T c6_theta_p[16];
  int32_T c6_i4;
  real_T c6_alpha_p[16];
  int32_T c6_i5;
  real_T c6_q[2];
  real_T c6_theta;
  ...
  real_T c6_err;
  int32_T c6_i6;
  real_T c6_b_theta_p[16];
  int32_T c6_i7;
  real_T c6_b_alpha_p[16];
  real_T c6_dv0[2];
  int32_T c6_i8;
  int32_T c6_i9;
  real_T c6_b_q_des[2];
  ...
  real_T *c6_b_err;
  real_T (*c6_b_q)[2];
  real_T (*c6_c_alpha_p)[16];
  real_T (*c6_c_theta_p)[16];
  ...
  c6_c_alpha_p = (real_T (*)[16])ssGetInputPortSignal(chartInstance->S, 1);
  c6_c_theta_p = (real_T (*)[16])ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  ...
  c6_theta_p[16], real_T c6_alpha_p[16], real_T c6_theta, real_T c6_q[2])
{
  ...
  c6_B = c6_theta_p[15] - c6_theta_p[0];
  c6_x = c6_A;
  c6_y = c6_B;
  c6_b_x = c6_x;
  c6_b_y = c6_y;
  ...
  while (c6_b_k < 16) {
    ...
    c6_b = c6_power(chartInstance, 1.0 - c6_s, 15.0 - c6_k);
    c6_c_y = c6_a * c6_b;
  ...
  *c6_inData)
{
  ...
  chartInstance = (SFc6_RobotSimInstanceStruct *)chartInstanceVoid;
  c6_mxArrayOutData = NULL;
  for (c6_i55 = 0; c6_i55 < 16; c6_i55++) {
    c6_b_inData[c6_i55] = (*(real_T (*)[16])c6_inData)[c6_i55];
  }

  for (c6_i56 = 0; c6_i56 < 16; c6_i56++) {
    c6_u[c6_i56] = c6_b_inData[c6_i56];
  }

  c6_y = NULL;
  sf_mex_assign(&c6_y, sf_mex_create("y", c6_u, 0, 0U, 1U, 0U, 2, 1, 16), FALSE);
  sf_mex_assign(&c6_mxArrayOutData, c6_y, FALSE);
  return c6_mxArrayOutData;
}
  ...
  const mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId, real_T c6_y[16])
{
  real_T c6_dv8[16];
  int32_T c6_i71;
  sf_mex_import(c6_parentId, sf_mex_dup(c6_u), c6_dv8, 1, 0, 0U, 1, 0U, 2, 1, 16);
  for (c6_i71 = 0; c6_i71 < 16; c6_i71++) {
  ...
  *c6_mxArrayInData, const char_T *c6_varName, void *c6_outData)
{
  ...
  for (c6_i72 = 0; c6_i72 < 16; c6_i72++) {
    (*(real_T (*)[16])c6_outData)[c6_i72] = c6_y[c6_i72];
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4013739214U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1642991412U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(401426352U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3014841538U);
}
...
mxArray *sf_c6_RobotSim_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("cEGUeC00MmWSFglg2xkiW");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          c6_alpha_p = (real_T (*)[16])ssGetInputPortSignal(chartInstance->S, 1);
          c6_theta_p = (real_T (*)[16])ssGetInputPortSignal(chartInstance->S, 0);
...
static void mdlSetWorkWidths_c6_RobotSim(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(2595334061U));
  ssSetChecksum1(S,(2362354699U));
  ssSetChecksum2(S,(3390254366U));
  ssSetChecksum3(S,(3124129109U));
